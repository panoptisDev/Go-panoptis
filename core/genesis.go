...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideLondon *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// - nil: if running the without the `init` command and without providing a network flag (--panoptis, --ropsten, etc..)
	// - defaulted: when a network flag is provided (--panoptis, --ropsten, etc..), genesis will hold the defaults
	...
	// Support custom config for PrimordialPanoptis fork with mainnet genesis.
	if genesis == nil && (storedcfg.PrimordialPanoptisBlock != nil ||
...
func (g *Genesis) configOrDefault(ghash common.Hash, chainId uint64) *params.ChainConfig {
	...
	case ghash == params.MainnetGenesisHash:
		switch chainId {
		case 187:
			return params.PanoptisConfig
		case 188:
			return params.PanoptisTestnetConfig
		default:
...
// DefaultPanoptisGenesisBlock returns the Panoptis mainnet genesis block.
func DefaultPanoptisGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.PanoptisConfig,
		Nonce:      66,
		ExtraData:  hexutil.MustDecode("0x11bbe8db4e347b4e8c937c1c8370e4b5ed33adb3db69cbdb7a38e1e50b1b82fa"),
		GasLimit:   5000,
		Difficulty: big.NewInt(17179869184),
...
// DefaultPanoptisTestnetGenesisBlock returns the Panoptis testnet genesis block.
func DefaultPanoptisTestnetGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.PanoptisTestnetConfig,
		Nonce:      66,
		ExtraData:  hexutil.MustDecode("0x11bbe8db4e347b4e8c937c1c8370e4b5ed33adb3db69cbdb7a38e1e50b1b82fa"),
		GasLimit:   5000,
		Difficulty: big.NewInt(17179869184),
