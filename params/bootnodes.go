...
// PanoptisBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Panoptis network.
var PanoptisBootnodes []string

// PanoptisTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Panoptis network.
var PanoptisTestnetBootnodes = []string{
...
func KnownDNSNetwork(genesis common.Hash, networkID uint64, protocol string) string {
	...
	if networkID == 187 || networkID == 188 {
		tld = ".panoptisdisco.net"
