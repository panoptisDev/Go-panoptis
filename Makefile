...
docker:
	docker build -t registry.gitlab.com/panoptis/go-panoptis:$(or $(TAG),latest) .

docker-alltools:
	docker build -f Dockerfile.alltools -t registry.gitlab.com/panoptis/go-panoptis:$(if $(TAG),$(TAG)-alltools,alltools) .

docker-debug:
	docker build -f Dockerfile.debug -t registry.gitlab.com/panoptis/go-panoptis:$(if $(TAG),$(TAG)-debug,debug) .
